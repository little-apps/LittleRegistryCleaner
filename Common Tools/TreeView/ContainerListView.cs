...
namespace Common_Tools.TreeView
{
	#region Enumerations
    ...
    [DesignTimeVisible(false), TypeConverter("Common_Tools.TreeView.ListViewItemConverter")]
...
*/
    ...
    [DesignTimeVisible(false), TypeConverter("Common_Tools.TreeView.SubListViewItemConverter")]
    ...
    [DesignTimeVisible(false), TypeConverter("Common_Tools.TreeView.ToggleColumnHeaderConverter")]
								...
								&& (tp_scr+(rowHeight*i)+2 < r.Top+r.Height-2-hsize))
							{
								...
								else
								{
									...
									else if (columns[j+1].TextAlign == HorizontalAlignment.Right)
									{
										...
										g.DrawString(sp, this.Font, (items[i].Selected && isFocused ? SystemBrushes.HighlightText : new SolidBrush(ForeColor)), (float)(lp_scr+last+iColWidthPlus1 /* BMS 2003-05-24 */-StringTools.MeasureDisplayStringWidth(g, sp, this.Font)-2), (float)(tp_scr+(rowHeight*i)+2));
									}
									else
									{
										sp = TruncatedString(items[i].SubItems[j].Text, iColWidthPlus1 /* BMS 2003-05-24 */ , 12, g);
										g.DrawString(sp, this.Font, (items[i].Selected && isFocused ? SystemBrushes.HighlightText : new SolidBrush(ForeColor)), (float)(lp_scr+last+(iColWidthPlus1 /* BMS 2003-05-24 */ /2)-(StringTools.MeasureDisplayStringWidth(g, sp, this.Font)/2)), (float)(tp_scr+(rowHeight*i)+2));
									}
								}
							}
							else /* BMS 2003-05-25 */
