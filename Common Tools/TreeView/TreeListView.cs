...
namespace Common_Tools.TreeView
{
	...
	/// </summary>
	[ToolboxItem(true)]
	[ToolboxBitmap(typeof(TreeListView), "Resources.treeview.bmp")]
	...
	public class TreeListView : ContainerListView
	{
		...
		public TreeListView(): base()
		{
            ...
            //Stream bitmapStream1 = myAssembly.GetManifestResourceStream("tv_minus.bmp");

            bmpMinus = Bitmap.FromHbitmap(Common_Tools.Properties.Resources.tv_minus.GetHbitmap());
            bmpPlus = Bitmap.FromHbitmap(Common_Tools.Properties.Resources.tv_plus.GetHbitmap());
	...
	#region TreeListNode
	[DesignTimeVisible(false), TypeConverter("TreeListNodeConverter")]
