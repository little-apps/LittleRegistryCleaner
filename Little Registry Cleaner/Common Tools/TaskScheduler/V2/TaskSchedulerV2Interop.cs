...
namespace Common_Tools.TaskScheduler.V2Interop
{
	...
	internal interface IRegisteredTask
	{
		...
		void GetRunTimes([In] ref Common_Tools.TaskScheduler.V1Interop.SystemTime pstStart, [In] ref Common_Tools.TaskScheduler.V1Interop.SystemTime pstEnd, [In, Out] ref uint pCount, [In, Out] ref IntPtr pRunTimes);
	}
